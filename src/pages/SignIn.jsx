        ...
        <>
            ...
            <Layout hideButton={true}>
                ...
                <Card className='w-full max-w-sm  mt-12 '>
                    <h2 className='font-bold text-sky-950 dark:text-white text-4xl text-center mb-7'>Sign In</h2>
                    <form className='flex flex-col gap-6 mb-1 '  onSubmit={handleLoginForm}>
                        <div className="relative">
                            ...
                            <FaUser className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-white" />
                        </div>
                        <div className="relative">
                            ...
                            <span onClick={handleTogglePassword} className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-white">
