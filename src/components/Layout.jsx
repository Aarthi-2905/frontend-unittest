        ...
        <div className='min-h-screen  overflow-hidden '>
            ...
            <section className='flex justify-between items-center max-lg:flex-col '>
                ...
                <div className='flex-1 p-3 max-w-3xl mx-auto gap-4 mt-11 py-8'>
                    <h2 className='font-palanquin capitalize text-4xl lg:max-w-lg dark:text-white ml-12'>
                        Data Integration Platform
                        <span className='text-teal-400'> For </span>
                        <span className='text-teal-400'> Data AI</span>
                    </h2>
                    <p className='mt-4 lg:max-w-lg info-text ml-12'>
                    ...
                    <p className='mt-6 lg:max-w-lg info-text ml-12'>
                    ...
                    {!hideButton && (
                        <div className='mt-11'>
                            <Link to={'/sign-in'}>
                                <Button gradientDuoTone="purpleToBlue" size="lg" className='ml-12'>
                                    Get Started
